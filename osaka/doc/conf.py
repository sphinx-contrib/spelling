...
print sphinxcontrib.__file__
import sphinxcontrib.osaka
...
htmlhelp_basename = 'sphinxcontrib-osakadoc'
...
latex_documents = [
  ('index', 'sphinxcontrib-osaka.tex', u'sphinxcontrib-osaka Documentation',
